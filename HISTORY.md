...
- **Carousel Dialogue Card Overlay**: Wrapped the carousel slide text in a themed retro dialogue card container (`Carousel.tsx`) featuring a semi-transparent dark backdrop (`bg-gray-950/90`), `backdrop-blur-md`, a purple border with a hover glow effect, and the post excerpt on desktop. This completely separates the title and stats text from any high-contrast background image elements (like logos or screenshots), providing perfect readability.
