...
export const errorService = {
   ...
   * @param {Error} error - O objeto de erro original
   * @param {string} context - Onde o erro ocorreu (ex: "ao salvar post")
   * @param {Function} toastFn - Opcional: função showToast para exibir alerta imediato
   */
  handle: (error, context = "", toastFn = null) => {
