            ...
            <div className="flex items-center gap-2 group shrink-0 pr-4 border-r-2 border-purple-500/10">
              <Link to="/" className="flex items-center gap-3" onClick={() => { handleCategorySelect("Todos"); setSearchQuery(""); }}>
                <div className="relative">
                  <Gamepad2 className={cn("w-8 h-8 transition-transform group-hover:-rotate-12 drop-shadow-[0_0_8px_rgba(168,85,247,0.5)] logo-glow-pulse", isDark ? "text-purple-400" : "text-purple-600")} />
                ...
                <h1 className={cn(
                  ...
                  Begins<span className="text-purple-500 inline-block animate-glitch logo-glow-pulse drop-shadow-[0_0_10px_rgba(168,85,247,0.4)]">Project</span>
                </h1>
              </Link>
            </div>
