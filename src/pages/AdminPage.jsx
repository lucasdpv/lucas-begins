    ...
    <div className="animate-in fade-in max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div className="flex items-center gap-4">
          <button
            onClick={onBack}
            className={`p-3 rounded-lg retro-button ${
        ...
        <div className="flex gap-4">
          {["posts", "categories"].map((tab) => (
            <button
              ...
              className={`px-6 py-3 rounded-xl font-retro text-sm uppercase font-bold retro-button ${
                adminTab === tab
      ...
      {adminTab === "posts" && (
        <div className="space-y-6">
          ...
          <div className={`rounded-2xl retro-card overflow-hidden ${isDark ? "bg-gray-800" : "bg-white"}`}>
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm font-medium">
                <thead
                  className={`font-retro uppercase text-xs tracking-wider border-b-2 ${
                  ...
                  {posts.map((post) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 hidden md:table-cell">
                        <span
                          className={`px-3 py-1 rounded-md text-xs uppercase font-retro font-bold border ${
                            isDark
            ...
            <form onSubmit={handleAddCat} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full p-4 rounded-xl outline-none border-2 font-medium focus:border-purple-500 transition-all ${
          ...
          <div className={`p-8 rounded-2xl retro-card ${isDark ? "bg-gray-800" : "bg-white"}`}>
            ...
            <div className="space-y-3">
              {categories.map((cat) => (
                <div
                  key={cat}
                  className={`flex items-center justify-between p-4 rounded-xl border-2 font-retro font-bold uppercase text-sm ${
