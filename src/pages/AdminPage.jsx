  ...
  return (
    <div className="min-h-[80vh] py-8 px-4 md:px-8 relative overflow-hidden animate-in fade-in duration-700">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
          <div className="flex items-center gap-6">
            <button
              onClick={() => navigate("/")}
              className={cn(
                "p-4 rounded-2xl border-4 transition-all active:scale-95 group",
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div className="flex items-center gap-2 px-4 py-1.5 bg-purple-600/10 border border-purple-500/30 rounded-full">
                  <Settings size={14} className="text-purple-500 animate-spin-slow" />
                  <span className="font-retro text-[11px] font-bold uppercase tracking-[0.2em] text-purple-500">Admin Mode Active</span>
                </div>
              </div>
              <h1 className="font-retro font-bold text-4xl md:text-6xl uppercase tracking-tighter drop-shadow-[4px_4px_0px_rgba(0,0,0,1)]">
          ...
          <button
            ...
            className="group flex items-center gap-3 px-8 py-4 bg-yellow-400 border-4 border-black text-black font-retro text-lg font-bold uppercase shadow-[6px_6px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[8px_8px_0px_rgba(0,0,0,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {[
            ...
            <div
              key={stat.label}
              className={cn(
                "p-6 rounded-[2.5rem] border-4 flex items-center gap-5 transition-all group",
            ...
            >
              ...
              <div>
                <p className="text-xs font-retro font-bold uppercase tracking-widest opacity-50 mb-1">{stat.label}</p>
                <p className="text-3xl font-bold font-retro leading-none">{stat.value}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className={cn(
          "p-2 rounded-[2.5rem] border-4 mb-10 flex flex-wrap items-center justify-center lg:justify-start gap-2 backdrop-blur-md transition-all",
          ...
          {[
            ...
            <button
              ...
              className={cn(
                "relative flex items-center gap-3 px-8 py-4 rounded-[1.8rem] font-retro text-sm font-bold uppercase tracking-widest transition-all duration-300",
                adminTab === tab.id 
            ...
            >
              ...
              {tab.label}
              {tab.badge && (
                <span className="absolute top-3 right-4 w-2.5 h-2.5 bg-red-500 rounded-full animate-pulse border-2 border-white dark:border-gray-900 shadow-sm" />
              )}
            </button>
          ))}
        </div>
            ...
            <div className="flex flex-1 w-full md:w-auto gap-4 items-center">
              ...
              <div className="relative flex-1 max-w-md group">
                ...
                <input
                  ...
                  className={cn(
                    "w-full pl-12 pr-4 py-3 rounded-xl border-2 outline-none font-medium transition-all",
                    isDark 
              ...
              <div className="relative group">
                <Filter className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 group-focus-within:text-purple-500" />
                <select
                  value={filterCategory}
                  onChange={(e) => setFilterCategory(e.target.value)}
                  className={cn(
                    "pl-10 pr-8 py-3 rounded-xl border-2 outline-none font-bold uppercase text-xs font-retro appearance-none cursor-pointer transition-all",
                    isDark 
      ...
      {adminTab === "messages" && (
        <div className="space-y-6">
          <div className={cn("rounded-2xl retro-card overflow-hidden", isDark ? "bg-gray-800" : "bg-snes-surface")}>
            <div className="p-6 border-b-2 border-purple-500/20 flex items-center justify-between">
               <h3 className="font-retro text-2xl font-bold uppercase flex items-center gap-2">
                 <Inbox className="w-6 h-6 text-purple-500" /> Inbox de Mensagens
               </h3>
               <button 
              ...
              <table className="w-full text-left text-sm">
                <thead className={cn(
                  ...
                  <tr>
                    ...
                    <th className="px-6 py-5">Remetente</th>
                    <th className="px-6 py-5 hidden md:table-cell">Mensagem</th>
