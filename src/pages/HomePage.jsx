        ...
        <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <aside className="hidden lg:block lg:col-span-1">
              <div className={cn("h-full md:h-[560px] p-6 rounded-3xl glass-card flex flex-col relative overflow-hidden", isDark ? "" : "bg-snes-light/50")}>
        ...
        <div className="lg:col-span-4">
          <section>
            ...
            {isLoadingPosts ? (
              ...
              <div className={cn("p-12 text-center rounded-2xl retro-card", isDark ? "bg-gray-800" : "bg-snes-light border-2 border-black")}>
